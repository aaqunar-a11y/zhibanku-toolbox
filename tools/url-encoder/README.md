...
把中文、空格、特殊符号转换成百分号编码（percent-encoding），或把 URL 还原成可读文本。三种模式随时切换，输入即转换。所有处理在浏览器本地完成。
...
- **SHA-256**：`4aed79e64b7568fcf53a47bd1ed2bd4a6c766bef8db81a8cfd8e1fbfee359ea1`
- **体积**：12923 字节（约 12.6 KB）
